...
#Instalacja Ubuntu
  ...
  echo "Installing stud"
   ...
   echo "Changing limits of open files..."
    ...
    echo "mongodb     soft    nofile  100000" | sudo tee -a /etc/security/limits.conf
    echo "mongodb     hard    nofile  100000" | sudo tee -a /etc/security/limits.conf

    echo "redis     soft    nofile  100000" | sudo tee -a /etc/security/limits.conf
    echo "redis     hard    nofile  100000" | sudo tee -a /etc/security/limits.conf
    ...
    echo "stud     soft    nofile  100000" | sudo tee -a /etc/security/limits.conf
    echo "stud     hard    nofile  100000" | sudo tee -a /etc/security/limits.conf

    echo "castle     soft    nofile  100000" | sudo tee -a /etc/security/limits.conf
    echo "castle     hard    nofile  100000" | sudo tee -a /etc/security/limits.conf
